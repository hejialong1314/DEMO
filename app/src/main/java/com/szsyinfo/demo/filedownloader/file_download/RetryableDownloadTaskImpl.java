...
import com.szsyinfo.demo.filedownloader.file_download.DownloadTaskImpl.FinishState;
...
import com.szsyinfo.demo.filedownloader.file_download.base.RetryableDownloadTask;
...
import com.szsyinfo.demo.filedownloader.listener.OnRetryableFileDownloadStatusListener;
    ...
    public RetryableDownloadTaskImpl(FileDownloadTaskParam taskParamInfo, DownloadRecorder downloadRecorder,
        ...
        // ------------start checking base conditions------------
        {
            ...
            if (mFileDownloadTaskImpl == null || mFileDownloadTaskImpl.isStopped()) {
                // stop self
                stop();
                FinishState finishStateInternal = mFileDownloadTaskImpl.getFinishState();
