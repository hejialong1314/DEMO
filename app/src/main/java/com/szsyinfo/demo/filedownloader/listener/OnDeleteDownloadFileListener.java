...
import com.szsyinfo.demo.filedownloader.base.UrlFailReason;
...
public interface OnDeleteDownloadFileListener {
     ...
     * prepared delete
     *
     * @param downloadFileNeedDelete download file needed to delete (需要删除的下载文件)
     */
     ...
     * delete succeed
     *
     * @param downloadFileDeleted download file deleted(下载文件已删除)
     */
     ...
     * delete failed
     *
     * @param downloadFileInfo download file needed to delete,may be null (需要删除的下载文件，可能是空的)
     * @param failReason       fail reason (失败原因)
     */
